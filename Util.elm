...
dimUtils height width = 
    ...
    in {inBounds=inBounds, perimeter=perimeter, inverse=inverse, allPairs=allPairs, allNeighbors=allNeighbors, neighbors=neighbors, diagonals=diagonals, maze=maze}